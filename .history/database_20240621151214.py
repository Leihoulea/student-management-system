...
class Database:
    ...
    def delete_course(self, course_id):
        ...
        # 删除相关的选课记录
        sql = "DELETE FROM Enrollments WHERE course_id = %s"
        self.cursor.execute(sql, (course_id,))

        # 删除相关的成绩记录
        sql = "DELETE FROM CourseGrades WHERE course_id = %s"
        self.cursor.execute(sql, (course_id,))
    ...
    def update_student(self, student_id, name, gender, birthdate, photo_file_path=None):
        ...
        try:
            ...
            self.connection.rollback()
            raise ValueError(f"Failed to update student information: {e}")
