from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QPushButton, QTableWidget, QTableWidgetItem, QFormLayout, QLineEdit, QDialog, QMessageBox, QFileDialog, QLabel, QInputDialog
...
class StudentManagementSystem(QMainWindow):
    ...
    def initUI(self):
        ...
        self.layout.addWidget(self.enroll_student_button)
        self.layout.addWidget(self.view_enrollments_button)
        self.layout.addWidget(self.query_student_button)
        self.layout.addWidget(self.query_course_button)
        self.layout.addWidget(self.get_student_avg_grade_button)
    ...
    def view_enrollments(self):
        ...
        self.student_table.setRowCount(0)
        self.student_table.setColumnCount(4)
        self.student_table.setHorizontalHeaderLabels(['Enrollment ID', 'Student ID', 'Course ID', 'Enrollment Date'])
    ...
    def get_student_avg_grade(self):
        ...
        if ok:
            db = Database()
            avg_grade = db.GetStudentAverageGrade(student_id)
