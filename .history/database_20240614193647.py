...
class Database:
    ...
    def add_student(self, student_id, name, gender, birthdate, major_id, photo_file_path=None):
        ...
        sql = "INSERT INTO Students (student_id, name, gender, birthdate, major_id, photo) VALUES (%s, %s, %s, %s, %s, %s)"
        self.cursor.execute(sql, (student_id, name, gender, birthdate, major_id, photo_blob))
