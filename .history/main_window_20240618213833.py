...
class AdminMainWindow(QMainWindow):
    ...
    def init_course_tab(self):
        ...
        self.delete_course_button = QPushButton('Delete Course')  # 添加删除课程按钮
        ...
        course_buttons_layout.addWidget(self.delete_course_button)  # 添加删除课程按钮到布局
        ...
        self.delete_course_button.clicked.connect(self.delete_course)  # 连接删除课程按钮的信号
